<?php
class Vickyedu extends \PHPUnit_Framework_TestCase
{   
	public function testExpiredMembership()
    { 
        $Content_JSON = file_get_contents('C:\wamp64\www\Mytask\mytask\vickyedu_json.json');    
        ...
        $result = $vickyeduInfo->getValidation($state,$jsonObj);
